...
create table trip (
   ...
   streetsimplefailure integer not null,
   streetcriticalfailure integer not null,
   highwaysimplefailure integer not null,
   highwaycriticalfailure integer not null,
   throttleintervention integer not null,
   cancellationintervention integer not null,
